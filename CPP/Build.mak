...
CFLAGS = $(CFLAGS) -nologo -c -Fo$O/ $(CFLAGS_WARN_LEVEL) -WX -EHsc -Gy -GR- -GF -GL -Gw -std:c++20 -Zc:enumTypes
...
!IFNDEF UNDER_CE
LFLAGS = $(LFLAGS) /LTCG /LARGEADDRESSAWARE /DEPENDENTLOADFLAG:0x800 /BREPRO
!ENDIF
